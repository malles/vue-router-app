<template>
    <div>
        ...
        <partial name="less-component"></partial>
...
<script>
    ...
    module.exports = {
        ...
        partials: {
            ...
            'less-component':  require('../../src/templates/less-component.html')
        },
        ...
        data() {
            return {
                ...
                javascript: { name: 'javascript', params: { namespace: 'components', component: 'notification'} },
